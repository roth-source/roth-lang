...
public class Time implements Serializable, Comparable<Time>, Cloneable
{
	...
	public Time setHour(int hour)
	{
		...
		{
			throw new RuntimeException("invalid hour value " + hour);
		}
	}
	...
	public Time setMinute(int minute)
	{
		...
		{
			throw new RuntimeException("invalid minute value " + minute);
		}
	}
	...
	public Time setSecond(int second)
	{
		...
		{
			throw new RuntimeException("invalid second value " + second);
		}
	}
	...
	public Time setMillisecond(int millisecond)
	{
		...
		{
			throw new RuntimeException("invalid millisecond value " + millisecond);
		}
	}
	...
	public static Time parse(java.lang.String value, java.lang.String pattern)
	{
		return new Time(parseCalendar(value, pattern));
	}
	
	public static Time parse(java.lang.String value, TimeZone timeZone, java.lang.String pattern)
	{
		return new Time(parseCalendar(value, timeZone, pattern));
	}
	
	public static Calendar parseCalendar(java.lang.String value, java.lang.String pattern)
	{
		return parseCalendar(value, TimeZone.DEFAULT, pattern);
	}
	
	public static Calendar parseCalendar(java.lang.String value, TimeZone timeZone, java.lang.String pattern)
	{
	...
	{
		return getDefaultPattern() != null ? format(getDefaultPattern()) : java.lang.String.valueOf(toTimestamp());
	}
	
	public java.lang.String format(TimeZone timeZone)
	{
	...
	public java.lang.String format(java.lang.String pattern, TimeZone timeZone)
	{
		return (pattern != null || getDefaultPattern() != null) ? timeZone.getFormatter(pattern != null ? pattern : getDefaultPattern()).format(toDate()) : java.lang.String.valueOf(toTimestamp());
	}
