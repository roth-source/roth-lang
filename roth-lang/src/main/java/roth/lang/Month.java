...
{
	public static final java.lang.String DEFAULT_PATTERN = "yyyy-MM";
	...
	public static Month parse(java.lang.String value)
	{
		return parse(value, TimeZone.DEFAULT);
	}
	
	public static Month parse(java.lang.String value, TimeZone timeZone)
	{
		return parse(value, timeZone, DEFAULT_PATTERN);
	}
	
	public static Month parse(java.lang.String value, java.lang.String pattern)
	{
		return parse(value, TimeZone.DEFAULT, pattern);
	}
	
	public static Month parse(java.lang.String value, TimeZone timeZone, java.lang.String pattern)
	{
