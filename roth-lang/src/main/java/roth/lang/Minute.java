...
{
	public static final java.lang.String DEFAULT_PATTERN = "yyyy-MM-dd HH:mm";
	...
	public static Minute parse(java.lang.String value)
	{
		return parse(value, TimeZone.DEFAULT);
	}
	
	public static Minute parse(java.lang.String value, TimeZone timeZone)
	{
		return parse(value, timeZone, DEFAULT_PATTERN);
	}
	
	public static Minute parse(java.lang.String value, java.lang.String pattern)
	{
		return parse(value, TimeZone.DEFAULT, pattern);
	}
	
	public static Minute parse(java.lang.String value, TimeZone timeZone, java.lang.String pattern)
	{
